...
const DataView = ({
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 p-6 bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 rounded-lg shadow-lg">
      ...
      <div className="flex md:flex-row flex-col gap-4 items-center justify-between">
        {search && (
          <Input
            ...
            className="w-full md:w-96 border border-purple-300 focus:ring-purple-500"
          />
        )}
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          <div className="flex gap-4">
            ...
            <Button
              ...
              size="sm"
              onClick={shareData}
              className="bg-gradient-to-r from-pink-500 to-red-500 text-white hover:opacity-90"
            >
            ...
            <div className="flex gap-2">
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className="w-40 bg-white border border-purple-300 hover:bg-purple-50"
                  >
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className="w-40 bg-white border border-pink-300 hover:bg-pink-50"
                  >
      ...
      <div className="overflow-hidden rounded-md border border-purple-300 shadow-md">
        <Table>
          <TableHeader className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white">
            <TableRow>
              {columns?.map((column: any) => (
                <TableHead role="columnheader" key={column.id}>
                  {column.text}
                </TableHead>
              ))}
            </TableRow>
